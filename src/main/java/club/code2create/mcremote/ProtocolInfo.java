 ...
 *
 * hello で名乗る版は **clean な protocol semver `23.1.0`**（DECISIONS 2026-09-01-01）。
 * b7 は direction 四methodとdamage-capableなfull lightningを後方互換追加する。
 * 配布パッケージ版 `2301.0.0b7`（fold 形・`b7` 接尾辞）は jar/PyPI 名のレイヤであって
...
public final class ProtocolInfo {
     ...
     * パッケージ版は gradle.properties の pluginVersion（`2301.0.0b7`）＝こことは別レイヤ。
     */
    public static final String PROTOCOL = "23.1.0";
