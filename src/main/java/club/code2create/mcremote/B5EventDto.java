...
final class B5EventDto {
    ...
    static Map<String, Object> chatPosted(
        ...
        Map<String, Object> dto = common("chat_posted", dimension, origin);
    ...
    static Map<String, Object> projectileHit(
        ...
        Map<String, Object> dto = common("projectile_hit", dimension, origin);
    ...
    private static Map<String, Object> common(String type, String dimension, List<Integer> origin) {
        Map<String, Object> dto = new LinkedHashMap<>();
        dto.put("type", type);
        dto.put("dimension", dimension);
